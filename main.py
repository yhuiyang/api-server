...
_routes = [
    ...
    RedirectRoute(r'/costco/campaign/<camp_id:[1-9]\d*>/toggle_publish', handler=handlers.CostcoCampaignTogglePublish,
                  name='costco-campaign-toggle-publish-state', strict_slash=True),
